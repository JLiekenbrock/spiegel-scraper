...
def by_url(article_url: str,proxie):
    html = html_by_url(article_url,proxie)
    return scrape_html(html)


def html_by_url(article_url: str, proxie):
    return requests.get(article_url, proxies=proxie).text
